...
//                 // Create matchInfo from recipe data
//                 const matchInfo = {
//                   matchPercentage: Math.round(Number(recipe.matchPercentage) || 0),
//                   totalIngredients: recipe.totalIngredients || 0,
//                   availableIngredients: recipe.ingredientsUserHas || 0,
//                   missingIngredients: [],
//                   status: (Math.round(Number(recipe.matchPercentage) || 0) >= 100) ? 'ready' :
//                           (Math.round(Number(recipe.matchPercentage) || 0) >= 75) ? 'almost-ready' : 'needs-ingredients'
//                 };
